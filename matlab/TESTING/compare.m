%% Load data
% LMPC_sys=load('LMPC_sysH_K_T02_N20.mat');
LMPC_art=load('LMPC_artH_K_T02_N20.mat');
% NMPC_sys=load('NMPC_sysH_K_T02_N20.mat');
NMPC_art=load('NMPC_artH_K_T02_N20.mat');
LMPC_sys=load('LMPC_sysH_K_T02_N5_noCONS.mat');
NMPC_sys=load('LBMPC_sysH_K_T02_N5_noCONS.mat');
