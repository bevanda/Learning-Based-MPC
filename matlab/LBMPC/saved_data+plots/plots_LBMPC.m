...
plot(0:iterations, LBMPC60.sysH(1,:),'Linewidth',1.5,'Color','r'); hold on;
plot(0:iterations,LBMPC60r.sysH(1,:),'Linewidth',1.5,'Color','g'); hold on;
...
plot(0:iterations, LBMPC60.sysH(2,:),'Linewidth',1.5,'Color','r'); hold on;
plot(0:iterations,LBMPC60r.sysH(2,:),'Linewidth',1.5,'Color','g'); hold on;
plot(0:iterations,0*(0:iterations),'Linewidth',1,'LineStyle',':','Color','k'); 
grid on;
xlabel('iterations');
ylabel('\delta x_2');
title('pressure rise');
legend({'LBMPC N=50' 'LBMPC N=60','LBMPC relax N=60'},'Location','northwest')
...
plot(0:iterations, LBMPC60.sysH(3,:),'Linewidth',1.5,'Color','r'); hold on;
plot(0:iterations,LBMPC60r.sysH(3,:),'Linewidth',1.5,'Color','g'); hold on;
plot(0:iterations,0*(0:iterations),'Linewidth',1,'LineStyle',':','Color','k'); 
grid on;
xlabel('iterations');
ylabel('\delta x_3');
...
plot(0:iterations, LBMPC60.sysH(4,:),'Linewidth',1.5,'Color','r'); hold on;
plot(0:iterations,LBMPC60r.sysH(4,:),'Linewidth',1.5,'Color','g'); hold on;
plot(0:iterations,0*(0:iterations),'Linewidth',1,'LineStyle',':','Color','k'); 
grid on;
xlabel('iterations');
ylabel('\delta x_4');
...
plot(0:iterations, LBMPC60.sysH(5,:),'Linewidth',1.5,'Color','r'); hold on;
plot(0:iterations,LBMPC60r.sysH(5,:),'Linewidth',1.5,'Color','g'); hold on;
plot(0:iterations,0*(0:iterations),'Linewidth',1,'LineStyle',':','Color','k'); 
grid on;
xlabel('iterations');
ylabel('\delta u');
