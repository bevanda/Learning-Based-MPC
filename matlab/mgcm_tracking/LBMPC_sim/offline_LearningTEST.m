...
%     [xl_k1, ul] = nominalModel(xl,c); % linear model
%     [xo,uo]=learnedDynamics(xo,c,data); % learned model
    ...
    q=iterations; % moving window of q datapoints 
