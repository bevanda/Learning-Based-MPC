function example_8_39
% example_8_39
% This example can be used to test whether solutions eminating from the
% computed set of initial values satisfy the constraints and stay feasible.
% Here, the variables ubar and eta denote the parameters used in the book.
    addpath('./nmpcroutine');
    clear all;
    close all;
...
function plotTrajectories(dynamic, system, T, t0, x0, u, ...
    ...
    figure(1);
        ...
        grid on;
        hold on;
        plot([-1      -1 0.5-eta 1        1 -0.5+eta -1], ...
             [-0.5+eta 1 1       0.5-eta -1 -1       -0.5+eta], 'k');
