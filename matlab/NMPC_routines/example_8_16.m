function example_8_16

% Example 8.16 from the second edition of L. Gruene, J. Pannek, Nonlinear 
% Model Predictive Control. Theory and Algorithms. Springer, 2017

Nstart = 2;
Nend   = 30;
for i = Nstart:2:Nend
    mpc_example_economic(1.9,i,1,2.0,1,2);
end;
plot([0,30],[2,2],'k-');
plot([0,30],[0,0],'k--');
axis([0,30,-0.1,2.1]);
latexxlabel('$$k$$',18);
latexylabel('$$x_{u_{N,x}^*}(k,x)$$',18);
latextitle('Open loop optimal trajectories for $$N=2,4,6,\ldots,30$$',18);
