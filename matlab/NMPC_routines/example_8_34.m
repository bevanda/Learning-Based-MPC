function example_8_34

% Example 8.34 from the second edition of L. Gruene, J. Pannek, Nonlinear 
% Model Predictive Control. Theory and Algorithms. Springer, 2017

[t,x,u]=mpc_example_economic(1.9,5,1,2,30,2);
figure(1);
latexxlabel('$$k$$',18);
...
[t,x,u]=mpc_example_economic(1.9,10,1,2,30,3);
figure(2);
latexxlabel('$$k$$',18);
latexylabel('$$x_{\mu_N}(k)$$ (solid) and $$x_{u^*_N}(\cdot)$$ (dashed)',18);
plot([0,40],[2,2],'k-');
